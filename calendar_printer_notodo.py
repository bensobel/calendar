...
def main():
    ...
    #get all calendars
    client = caldav.DAVClient('https://caldav.fastmail.com/dav/principals/user/ben@bensobel.org/', username=settings.CALUSER, password=settings.CALPW)
    try:
    ...
    for cal in calendar_list:
        eventsResult = events = c.date_search(start_of_day, end_of_day)
        all_events += events
